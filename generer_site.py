...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .nav{position:sticky;top:0;background:color-mix(in srgb,var(--bg) 88%,transparent);backdrop-filter:saturate(140%) blur(10px);border-bottom:1px solid var(--line);z-index:10;}
...
<header>
  <div class="wrap">
    ...
    <button class="theme-toggle theme-btn" id="theme-toggle" title="Mode jour/nuit">☀</button>
